...
//        assert(
//          new File(saveFile).getFreeSpace() == new File(inputPath).getFreeSpace
//        )
//      }
//    }
//  }
...
//    val savePath = "./download"
//    val getResult =
//      MinioOps.getFile("test", "input44.csv", savePath, "input.csv")
...
//    val savePath = "./download"
//    val getResult =
//      MinioOps.getFile("test66", "input.csv", savePath, "input.csv")
...
//      case Success(_) => {
//        val getResult =
//          MinioOps.getFile("test", "input.csv", savePath, "input.csv")
//        getResult.failure.exception shouldBe a[MinioBucketFileNotFoundException]
//      }
//    }
//  }
